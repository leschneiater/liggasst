...
const ContratosProfissional: React.FC = () => {
  ...
  const filteredContracts = contracts.filter(contract => {
    ...
    const matchesSearch = contract.empresa.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-roboto text-gray-600">
            Acompanhe todos os seus contratos e projetos
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="font-roboto text-sm text-gray-600">Valor Total Recebido</p>
                <p className="font-poppins font-bold text-2xl text-soft-black">
...
export default ContratosProfissional;