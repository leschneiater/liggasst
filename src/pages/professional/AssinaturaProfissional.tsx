...
const AssinaturaProfissional: React.FC = () => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-roboto text-gray-600">
            Gerencie seu plano e aproveite todos os benefícios da LiggaSST
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="font-roboto text-sm text-gray-600">
                Apareça em destaque nas buscas e receba mais oportunidades
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-roboto text-sm text-gray-600">
                Ganhe credibilidade com o selo de profissional verificado
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-roboto text-sm text-gray-600">
                Receba quantas propostas quiser sem limitações
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-roboto text-sm text-gray-600">
                Acesso a relatórios, calendário e gestão completa
              </p>
            </div>
          </div>
        </div>
...
export default AssinaturaProfissional;