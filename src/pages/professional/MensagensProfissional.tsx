...
const MensagensProfissional: React.FC = () => {
  const [conversations] = useState<Conversation[]>([
    {
      id: '1',
      company: 'TechCorp Ltda',
      lastMessage: 'Quando podemos agendar a visita técnica?',
      ...
      messages: [
        {
          id: '1',
          sender: 'company',
          content: 'Olá! Gostaria de solicitar um orçamento para PCMSO.',
        ...
        },
        {
          id: '3',
          sender: 'company',
          content: 'Temos 150 funcionários. Quando podemos agendar a visita técnica?',
          timestamp: '2024-01-15T14:30:00Z',
          read: false
        }
      ]
    },
    {
      ...
      lastMessage: 'Perfeito! Aguardo o cronograma.',
      ...
      messages: [
        ...
        },
        {
          id: '2',
          sender: 'me',
          content: 'Posso ajudar! Vou enviar uma proposta detalhada até amanhã.',
        ...
        },
        {
          id: '3',
          sender: 'company',
          content: 'Perfeito! Aguardo o cronograma.',
          timestamp: '2024-01-14T16:45:00Z',
          read: true
        }
      ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="font-roboto text-gray-600">
            Converse diretamente com as empresas interessadas
          </p>
        </div>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div className="w-10 h-10 bg-green-light rounded-full flex items-center justify-center flex-shrink-0">
                        <Building2 size={20} className="text-green-deep" />
                      </div>
...
export default MensagensProfissional;